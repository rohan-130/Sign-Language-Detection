...
def multidimensional_viterbi(evidence_vector, states, prior_probs, transition_probs, emission_paras, num_dimensions=2):
    ...
    if probability == 0:
        return None, 0
    # print("math.e**probability below:")
    # print(decimal.Decimal(math.e)**decimal.Decimal(probability))
    return sequence, decimal.Decimal(math.e)**decimal.Decimal(probability)
...
def divide_into_num_states(evidence_vectors, num_states):
    result = [[]]*num_states
